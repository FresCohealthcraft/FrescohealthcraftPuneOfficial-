...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F9F8F4] text-[#1A1A1A] flex flex-col font-sans select-none antialiased">
      ...
      <main className="flex-1">
        ...
        <section className="py-10 bg-[#4A8824] text-[#F9F8F4] relative overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
                ...
                <div className="space-y-1.5 text-left">
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2.5">
                    <span className="bg-[#F9F8F4] text-[#4A8824] text-[9.5px] font-bold px-3 py-1.5 rounded-full uppercase tracking-widest border border-white/10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
            ...
            <div className="md:col-span-3 text-left">
              <h4 className="font-bold text-[11px] text-[#4A8824] uppercase tracking-[0.25em]">
                Quick Links
              </h4>
