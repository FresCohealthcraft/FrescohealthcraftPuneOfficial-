...
export default function ContactSection({ onStartOrdering, onGeneralChat }: ContactSectionProps) {
  return (
    <section id="contact" className="py-12 bg-[#F9F8F4] scroll-mt-20 border-t border-[#1A1A1A]/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch">
          ...
          <div className="bg-white border border-[#1A1A1A]/10 rounded-3xl p-6.5 sm:p-8 shadow-[0_4px_24px_rgba(0,0,0,0.01)] flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="space-y-4.5">
                ...
                >
                  <div className="p-2.5 bg-[#EFECE5] text-[#4A8824] rounded-xl mt-0.5 shrink-0 group-hover:bg-[#4A8824] group-hover:text-white transition-all duration-200">
                    <MapPin className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="font-bold text-sm text-[#1A1A1A] group-hover:text-[#4A8824] transition-all duration-200">Our Location</h4>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-[#1A1A1A] group-hover:text-[#4A8824] transition-all duration-200">Phone / WhatsApp</h4>
                    <p className="text-xs text-[#1A1A1A] mt-0.5 font-semibold group-hover:text-[#4A8824] group-hover:underline transition-all duration-200">
                      +91 89833 63146
                    </p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-[#1A1A1A] group-hover:text-[#4A8824] transition-all duration-200">Email</h4>
                    <p className="text-xs text-[#1A1A1A]/70 mt-0.5 font-medium group-hover:text-[#4A8824] group-hover:underline transition-all duration-200">
                ...
                <div className="flex items-start space-x-3.5">
                  <div className="p-2.5 bg-[#EFECE5] text-[#4A8824] rounded-xl mt-0.5 shrink-0">
                    <Clock className="w-5 h-5 text-[#4A8824]" />
                  </div>
                  <div>
            ...
            <div className="mt-8">
              <button
                ...
                className="w-full bg-[#1A1A1A] hover:bg-[#4A8824] text-white py-3.5 rounded-xl text-xs uppercase tracking-wider font-bold flex items-center justify-center space-x-1.5 transition-colors cursor-pointer"
              >
          ...
          <div className="bg-[#4A8824] text-white rounded-3xl p-6.5 sm:p-8 shadow-[0_12px_40px_rgba(74,136,36,0.12)] flex flex-col justify-between border border-[#4A8824]/80">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center space-x-3.5">
                  <div className="w-8 h-8 rounded-full bg-[#F9F8F4] text-[#4A8824] flex items-center justify-center font-bold text-xs shrink-0">
                    1
                  </div>
                  <div>
