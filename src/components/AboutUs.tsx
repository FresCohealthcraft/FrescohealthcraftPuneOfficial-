...
export default function AboutUs() {
  const USP_CARDS = [
    {
      id: "usp_1",
      icon: <Leaf className="w-5.5 h-5.5 text-[#4A8824]" />,
      title: "100% Natural",
    ...
    {
      id: "usp_3",
      icon: <Award className="w-5.5 h-5.5 text-[#4A8824]" />,
  ...
  return (
    <section id="about" className="py-12 bg-[#EFECE5]/20 scroll-mt-20 border-t border-[#1A1A1A]/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6">
            ...
            {/* About Us Badge */}
            <div className="inline-flex items-center justify-center border border-[#4A8824]/30 text-[#4A8824] bg-transparent px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider">
              About Us
            </div>
            ...
            <h2 className="text-3xl sm:text-4.5xl font-serif italic text-[#1A1A1A] tracking-tight leading-tight">
              ...
              <span className="text-[#4A8824]">One Sip at a Time</span>
            </h2>
            ...
            <div className="grid grid-cols-2 gap-4 w-full pt-4 max-w-sm">
              <div className="bg-white border border-[#1A1A1A]/10 shadow-[0_4px_24px_rgba(0,0,0,0.015)] rounded-3xl p-5 text-center">
                <span className="text-4xl font-serif font-extrabold text-[#4A8824] block">5+</span>
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#1A1A1A]/50 mt-1.5 block">Years Experience</span>
              </div>
              <div className="bg-white border border-[#1A1A1A]/10 shadow-[0_4px_24px_rgba(0,0,0,0.015)] rounded-3xl p-5 text-center">
                <span className="text-4xl font-serif font-extrabold text-[#4A8824] block">10K+</span>
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
            {USP_CARDS.map((usp) => (
              ...
              >
                ...
                {/* Icon wrapper */}
                <div className="p-3 bg-[#EFECE5] text-[#4A8824] inline-flex rounded-2xl mb-4">
                  {usp.icon}
                </div>
