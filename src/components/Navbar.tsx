...
export default function Navbar({
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#F9F8F4]/95 backdrop-blur-md border-b border-[#1A1A1A]/10 shadow-[0_1px_3px_rgba(0,0,0,0.02)] transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
              ...
              >
                ...
                {activeSection === link.id && (
                  <motion.div
                    ...
                    className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#4A8824] rounded-full"
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              onClick={onCartClick}
              className="relative p-2.5 text-[#1A1A1A] hover:text-[#4A8824] hover:bg-[#1A1A1A]/5 rounded-full transition-all cursor-pointer"
            >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden bg-[#F9F8F4] border-t border-[#1A1A1A]/10 overflow-hidden"
          >
