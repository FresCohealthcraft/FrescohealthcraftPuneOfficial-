          ...
          >
            ...
            <div className="p-6 overflow-y-auto space-y-5 flex-1">
                    ...
                    return (
                      <button
                        ...
                        className={`p-3.5 rounded-2xl text-left text-xs border transition-all duration-200 cursor-pointer flex flex-col justify-between ${
                          isSelected
                            ? "border-[#4A8824] bg-[#4A8824]/10 ring-0"
                            : "border-[#1A1A1A]/5 bg-white hover:bg-[#F9F8F4]"
                        }`}
                      >
                        <span className={`font-bold ${isSelected ? "text-[#4A8824]" : "text-[#1A1A1A]"}`}>
                          {sugar}
                        </span>
                      ...
                      >
                        <div className="flex items-center space-x-2.5">
                          <input
                            ...
                            checked={isChecked}
                            readOnly
                            className="h-4 w-4 rounded-md border-[#1A1A1A]/10 text-[#4A8824] focus:ring-[#4A8824] cursor-pointer"
                          />
                          <span className="font-bold text-[#1A1A1A]">{addon}</span>
                        </div>
                        <span className="font-mono font-bold text-[#4A8824]">
                          + ₹{price}
                        </span>
                      </div>
                    );
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full text-xs p-3.5 border border-[#1A1A1A]/10 rounded-2xl focus:outline-none focus:ring-1 focus:ring-[#4A8824] focus:border-[#4A8824] placeholder:text-gray-400"
                />
              </div>
              ...
              <div className="flex items-center justify-between pt-3 border-t border-[#1A1A1A]/5">
                ...
                <div className="flex items-center space-x-3 bg-[#F9F8F4] p-1.5 rounded-full border border-[#1A1A1A]/5">
                  <button
                    ...
                    className="p-1 text-[#1A1A1A]/60 hover:text-[#4A8824] hover:bg-white rounded-full transition-colors cursor-pointer"
                  >
            ...
            <div className="p-5 border-t border-[#1A1A1A]/5 bg-[#F9F8F4] flex flex-col gap-3">
              ...
              <div className="flex items-center justify-between px-1">
                ...
                <span className="text-3xl font-serif italic text-[#4A8824]">
                  ₹{overallPrice}
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                ...
                <button
                  ...
                  className="bg-[#1A1A1A] hover:bg-[#4A8824] text-white py-3.5 rounded-2xl font-bold text-xs uppercase tracking-widest cursor-pointer flex items-center justify-center space-x-1.5 transition-colors"
                >
