...
export default function HomeDeliveryBanner({ onOrderNow }: HomeDeliveryBannerProps) {
  return (
    <section className="py-4 bg-[#F9F8F4] border-t border-[#1A1A1A]/5">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        
        {/* Animated Slate Container mimicking Editorial Image Layout */}
        <div className="relative bg-[#4A8824] text-white rounded-3xl p-8 sm:p-11 shadow-[0_12px_40px_rgba(74,136,36,0.12)] overflow-hidden text-center z-10 border border-[#4A8824]/80">
