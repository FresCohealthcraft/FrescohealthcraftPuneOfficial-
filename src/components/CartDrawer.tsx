          ...
          >
            ...
            <div className="p-5 border-b border-[#1A1A1A]/5 flex items-center justify-between bg-[#EFECE5]/40">
              <div className="flex items-center space-x-2.5">
                <ShoppingCart className="w-5 h-5 text-[#4A8824]" />
                <div>
                  <h3 className="font-serif italic text-lg text-[#1A1A1A] leading-tight">
                    Your Wellness Cart
                  </h3>
                  <p className="text-[10px] uppercase font-bold tracking-widest text-[#4A8824] mt-1">
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-6">
              {cartItems.length === 0 ? (
                <div className="text-center py-16 flex flex-col items-center">
                  ...
                  <button
                    onClick={onClose}
                    className="mt-6 bg-[#1A1A1A] hover:bg-[#4A8824] text-white px-6 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all cursor-pointer"
                  >
                    Start Browsing
                  </button>
                </div>
                ...
                <>
                      ...
                      {cartItems.map((item) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="font-mono text-[11px] font-bold text-[#4A8824] mt-0.5">
                              ₹{item.finalPrice}
                            </p>
                  ...
                  <div className="border-t border-gray-105 pt-5 space-y-3 text-left">
                    <span className="text-xs font-bold text-[#1A1A1A]/80 uppercase tracking-widest flex items-center space-x-1.5">
                      <Compass className="w-4 h-4 text-[#4A8824] shrink-0" />
                    ...
                    <div className="space-y-2.5">
                      <input
                        ...
                        className="w-full text-xs p-3.5 border border-[#1A1A1A]/10 rounded-2xl focus:ring-1 focus:ring-[#4A8824] focus:outline-none bg-[#F9F8F4]/50 placeholder:text-gray-400"
                        required
                      />
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <select
                          ...
                          className="text-xs p-3.5 border border-[#1A1A1A]/10 rounded-2xl focus:ring-1 focus:ring-[#4A8824] focus:outline-none bg-[#F9F8F4]/50"
                        >
                  ...
                  <div className="border-t border-gray-105 pt-4 space-y-3 text-left">
                    <span className="text-xs font-bold text-[#1A1A1A]/80 uppercase tracking-widest flex items-center space-x-1.5">
                      <Compass className="w-4 h-4 text-[#4A8824]" />
                      <span>Delivery Payment Method</span>
                    </span>

                    <div className="bg-[#4A8824]/5 border border-[#4A8824]/10 rounded-2xl p-4.5 space-y-2 text-left">
                      <div className="flex items-center space-x-2">
                        <span className="text-lg">💵</span>
                        <h4 className="text-[11px] font-bold text-[#1A1A1A] uppercase tracking-wider">Cash or UPI on Delivery</h4>
                      </div>
                      <p className="text-[10px] text-gray-550 leading-normal">
                        Your order will be prepared and delivered fresh. You can pay our delivery partner directly using <strong>Cash</strong>, <strong>Google Pay</strong>, <strong>PhonePe</strong>, or any other UPI app scan once your premium wellness items arrive at your location.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {cartItems.length > 0 && (
              <div className="p-5 border-t border-[#1A1A1A]/10 bg-[#F9F8F4] space-y-4">
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <div className="flex justify-between text-gray-500">
                    <div>
                      ...
                      {isFreeDelivery && (
                        <span className="text-[9px] text-[#4A8824] font-bold ml-1.5 uppercase bg-[#4A8824]/10 px-1.5 py-0.5 rounded-md border border-[#4A8824]/10">
                          Free
                        </span>
                      )}
                    </div>
                  ...
                  <div className="flex justify-between text-sm items-center">
                    ...
                    <span className="text-2xl font-serif italic text-[#4A8824]">
                ...
                <button
                  ...
                  className="w-full bg-[#1A1A1A] hover:bg-[#4A8824] text-white py-4 rounded-xl font-bold text-xs uppercase tracking-widest cursor-pointer shadow-md flex items-center justify-center space-x-2 transition-transform active:scale-98"
                >
                  <svg
