          ...
          >
            ...
            <div className="p-5 border-b border-[#1A1A1A]/5 flex items-center justify-between bg-[#EFECE5]/40">
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold tracking-widest uppercase text-[#4A8824] mt-1 animate-pulse">
            ...
            <div className="p-6 overflow-y-auto space-y-6 flex-1 bg-white">
              ...
              <div className="bg-[#F9F8F4] p-4 rounded-2xl text-xs text-[#1A1A1A]/70 border border-[#1A1A1A]/5 flex items-start space-x-3">
                <Info className="w-5 h-5 text-[#4A8824] shrink-0 mt-0.5" />
                    ...
                    return (
                      <button
                        ...
                        className={`p-3.5 rounded-2xl border text-left text-xs font-bold transition-all flex items-center space-x-2.5 cursor-pointer ${
                          isSelected
                            ? "border-[#4A8824] bg-[#4A8824]/10 text-[#4A8824]"
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full text-xs p-3.5 border border-[#1A1A1A]/10 rounded-2xl focus:ring-1 focus:ring-[#4A8824] focus:outline-none bg-[#F9F8F4]/55"
                />
              </div>
              ...
              {!loading && (
                <button
                  ...
                  className="w-full py-4 bg-[#1A1A1A] hover:bg-[#4A8824] text-white rounded-2xl font-bold text-xs uppercase tracking-widest shadow-md transition-all flex items-center justify-center space-x-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <Sparkles className="w-5 h-5 text-yellow-300 animate-pulse" />
              ...
              {loading && (
                <div className="py-8 bg-[#F9F8F4] rounded-3xl border border-[#1A1A1A]/10 flex flex-col items-center justify-center text-center space-y-4">
                  <RefreshCw className="w-8 h-8 text-[#4A8824] animate-spin" />
                  <div>
                    <h4 className="font-bold text-[#1A1A1A] text-sm">Blending your ideas...</h4>
                    <p className="text-xs text-[#4A8824] font-bold mt-1.5 animate-pulse uppercase tracking-wider text-[11px]">
                      {[
                        "Consulting FresCo nutrition experts...",
                        "Analyzing your wellness goals...",
                        "Extracting bioactive plant ingredients...",
                ...
                <div className="space-y-6 pt-2 border-t border-gray-100">
                  ...
                  <div className="bg-[#F9F8F4] border border-[#1A1A1A]/10 p-6 rounded-3xl space-y-4 shadow-sm">
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-500 font-medium mt-1">
                          Flavor Accent: <span className="font-bold text-[#4A8824]">{recommendationResult.customRecipe.tasteProfile}</span>
                        </p>
                      </div>
                      ...
                      <ul className="grid grid-cols-2 gap-2">
                        {recommendationResult.customRecipe.ingredients.map((ing: string, i: number) => (
                           <li key={i} className="flex items-center space-x-2 text-gray-600 bg-white p-2.5 rounded-xl border border-[#1A1A1A]/5 font-medium">
                            <span className="text-[#4A8824] font-bold shrink-0">✔</span>
                    ...
                    <button
                      ...
                      className="w-full bg-[#1A1A1A] hover:bg-[#4A8824] text-white py-4 rounded-xl font-bold text-xs uppercase tracking-widest flex items-center justify-center space-x-2 cursor-pointer shadow-md"
                    >
                      ...
                      {recommendationResult.menuRecommendations.map((rec: any, k: number) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="bg-[#EFECE5] hover:bg-[#4A8824] hover:text-white text-[#1A1A1A] border border-[#1A1A1A]/10 px-4 py-2.5 rounded-xl text-xs uppercase tracking-wider font-bold cursor-pointer shrink-0"
                          >
                            Order Now
                          </button>
                        </div>
